        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto">
              ...
              <li className='fw-semibold'>Create account. <span className='text-primary fw-bold text-decoration-none btn ' data-bs-toggle="modal" data-bs-target="#exampleModal">It’s free!</span><BsFillCaretDownFill className='ms-1' /></li>
                  ...
                  {!toggle ? <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div className='row justify-content-center align-items-center px-3'>
                        ...
                        <div className='col d-flex flex-column justify-content-center align-items-center fs-11'>
